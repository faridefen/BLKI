                ...
                <div class="panel-body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>{{ $data->Renlakgiat->program_pelatihan }}</td>
                        </tr>
                        <tr>
                            <td>Sumber Dana</td>
                            <td>:</td>
                            <td>{{ $data->Renlakgiat->sumber_dana }}</td>
                        </tr>
                        <tr>
                            <td>Durasi</td>
                            <td>:</td>
                            <td>{{$data->Renlakgiat->durasi}}</td>
                        </tr>
                        <tr>
                            <td>Pakte</td>
                            <td>:</td>
                            <td>{{$data->Renlakgiat->paket}}</td>
                        </tr>
                        <tr>
                            <td>Orang</td>
                            <td>:</td>
                            <td>{{$data->Renlakgiat->orang}}</td>
                        </tr>
                        <tr>
                            <td>Tanggal Mulai</td>
                            <td>:</td>
                            <td>{{date('d M Y', strtotime($data->Renlakgiat->tgl_mulai))}}</td>
                        </tr>
                        <tr>
                            <td>Tanggal Selesai</td>
                            <td>:</td>
                            <td> {{date('d M Y', strtotime($data->Renlakgiat->tgl_selesai))}}</td>
                        </tr>
                        <tr>
                            <td>Status</td>
                            <td>:</td>
                            <td>{{ $data->Renlakgiat->status }}</td>
                        </tr>
                        <tr>
                            <td>Data Laporan</td>
                            <td>:</td>
